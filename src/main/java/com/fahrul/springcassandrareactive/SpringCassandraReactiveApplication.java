package com.fahrul.springcassandrareactive;
...
import com.fahrul.springcassandrareactive.repository.UserRepository;
...
@RestController
public class SpringCassandraReactiveApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(SpringCassandraReactiveApplication.class, args);
	}
